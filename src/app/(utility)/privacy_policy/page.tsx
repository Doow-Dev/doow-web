...
import { AboutBody, AboutSection, AboutSubHeading, AboutTitle, AboutWrapper } from "@/app/_components/terms-privacy";
import { PageHeading } from "@/app/_components/utility-page-shell";

export default function PrivacyPolicy() {
  return (
    <>
      <PageHeading eyebrow="Legal" title="Privacy Policy" description="Updated: 3 April 2023" />
      <div className="mt-10">
        <AboutWrapper>
          <AboutSection>
