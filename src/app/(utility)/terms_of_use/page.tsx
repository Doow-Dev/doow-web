...
import { AboutBody, AboutSection, AboutTitle, AboutWrapper } from "@/app/_components/terms-privacy";
import { PageHeading } from "@/app/_components/utility-page-shell";

export default function TermsOfUse() {
  return (
    <>
      <PageHeading eyebrow="Legal" title="Terms of Use" description="Updated: 3 April 2023" />
      <div className="mt-10">
        <AboutWrapper>
          <AboutSection>
