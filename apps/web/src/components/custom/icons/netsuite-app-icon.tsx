...
export function NetSuiteAppIcon({ className, ...props }: SVGProps<SVGSVGElement>) {
  ...
  return (
    ...
    >
      ...
      <mask
        ...
        height="9"
      >
        <path d="M70.297 6.252h4.623v7.903h-4.623z" fill="white" />
      </mask>
      <g mask={`url(#${firstMaskId})`}>
        <path d="M74.915 6.337H70.34v7.798h4.575v-.9h-3.687v-2.904h3.687v-.914h-3.687V7.253h3.687" fill="currentColor" />
      </g>
      <path d="M0-.001h12.13v10.387l-4.724-5.99H0" fill="currentColor" />
      <mask
        id={secondMaskId}
        maskUnits="userSpaceOnUse"
        style={{ maskType: "luminance" }}
        ...
        height="11"
      >
        <path d="M7.316 8.256h12.267v10.42H7.316z" fill="white" />
      </mask>
      <g mask={`url(#${secondMaskId})`}>
        <path d="M7.383 8.347c1.575 1.948 3.086 3.96 4.644 5.925h7.446v4.403H7.383" fill="currentColor" />
      </g>
      <path d="M12.89 4.38V.892h5.726v12.61h-3.803V4.38m-10.107.765v9.048h1.881v3.562H.902V5.145" fill="currentColor" />
    </svg>
  );
}
